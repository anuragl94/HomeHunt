...
{ 
if (form.rmcount.value != "" && (form.rmcount.value >5 || form.rmcount.value <1))
{
	return false; 
}
	</script>
  ...
  ?>
	<br><br><br>
	 <div class="container">
		...
		<br>
		<div class="container">
		<form ... onsubmit="return checkForm(this);" name = "frm" action="questionnaire_backend.php" method="post">
		...
		<div class="row"><p>
			No of Roommates: <input type ="number" min=1 max=5 name="rmcount" required><br>
		</div></p>
...
<div class="row"><p>
		...
		<input type="radio" name="flat" value="nhave">Don't have a flat
		</div></p>


		<div class="row"><p>
		<input type="checkbox" name="chk" onClick="apply()" required> I agree to the <a target="_blank" onclick="window.open('policies.html', 'width=200','_blank', 'toolbar=0,location=0,menubar=0, height=300, width= 300')"><u>privacy policy</u></a>
		<br>
