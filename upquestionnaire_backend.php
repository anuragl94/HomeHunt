...
$sql="UPDATE questionnaire SET Area='$_POST[Area]',Language='$_POST[language]',Vegetarian=$food,NoOfRoomies='$_POST[rmcount]',Gender='$_POST[Gender]',HaveAFlat=$chk WHERE User_ID='$userid'";
